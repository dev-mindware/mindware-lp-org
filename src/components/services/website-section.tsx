      ...
      <SectionWrapper className="py-32 container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground italic">
            Uma máquina de vendas funcionando 24/7 para você.
          </p>
        </motion.div>
          ...
          {[
            {
              icon: Search,
              title: "SEO Avançado",
              text: "Visibilidade imediata no Google e motores de busca.",
            },
            {
              icon: Globe,
              title: "Domínio & Host",
              text: "Tudo incluído por 1 ano para você não se preocupar.",
            },
            {
              icon: Smartphone,
              title: "Mobile Ready",
              text: "Experiência perfeita em smartphones e tablets.",
            },
          ].map((card, i) => (
            <motion.div
              key={i}
