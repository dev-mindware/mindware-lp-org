...
export function EmailServiceSection() {
  return (
    <section
      id="email-section"
      className="relative py-24 bg-muted/30 backdrop-blur-sm overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <SectionWrapper className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 space-y-4">
          ...
          >
            Aumente a confiança da sua marca com um email que carrega o seu
            nome. Segurança, IA e performance em um só lugar.
          </motion.p>
        </div>
                ...
                {plan.features.map((feature, i) => {
                  if (feature.startsWith("###")) {
                    return (
                      <h4
                        key={i}
                        className="text-xs font-bold text-primary mt-4 mb-2 uppercase tracking-wider"
                      >
                        {feature.replace("### ", "")}
                      </h4>
                    );
